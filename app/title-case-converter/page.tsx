  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Title case capitalizes the first letter of each major word in a sentence while leaving minor words like 'and', 'the', 'of' in lowercase.",
      },
    },
    {
      "@type": "Question",
      name: "Is this title case converter free?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "Which words are not capitalized in title case?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Minor words such as articles (a, an, the), coordinating conjunctions (and, but, or), and short prepositions (in, on, at, by, for, of, to) are not capitalized unless they are the first word.",
      },
    },
    {
      "@type": "Question",
...
const webAppSchema = {
  ...
  url: "https://yoursite.com/title-case-converter",
  description:
    "Convert any text to title case instantly with our free online title case converter. No download required.",
...
function toTitleCase(text: string): string {
  return text
    .toLowerCase()
    .replace(/\b\w+/g, (word, index, fullStr) => {
      // Always capitalize the first word and the last word
      const isFirst = index === 0 || fullStr.slice(0, index).trim() === "";
      if (isFirst || !minorWords.has(word)) {
...
export default function TitleCaseConverter() {
  ...
  const displayText = toTitleCase(text);
    ...
    <>
      ...
      <Head>
        ...
        <meta
          ...
          content="Convert any text to title case instantly. Free, fast, and secure."
        />
      ...
      >
        ...
        >
          <h1 className="text-2xl font-semibold mb-2">Title Case Converter</h1>
          <p className="text-sm mb-8 mx-auto max-w-lg" style={{ color: textMuted }}>
            Paste your text below and it converts to proper title case instantly — capitalizing
            major words and leaving minor ones lowercase.
          </p>
          ...
          >
            ...
            <textarea
              ...
              aria-label="Input text to convert to title case"
            />
            ...
            <div className="flex items-center gap-3 px-4 py-2" style={{ borderTop: borderStyle }}>
              <button className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium bg-orange-500 text-white hover:brightness-110 transition">
                <span className="text-xs font-bold opacity-80">Tt</span>
                Title Case
              </button>
            ...
            {text && (
              <div
                ...
                style={{
                  ...
                  background: isDark ? "rgba(249,115,22,0.04)" : "rgba(249,115,22,0.03)",
                }}
              >
                <span className="block text-xs font-bold uppercase tracking-widest mb-2 text-orange-500">
                  Preview
                </span>
                <div
        ...
        <div className="max-w-3xl mx-auto px-4 pb-20">
          ...
          <section className="pt-10" aria-label="Introduction">
            <p
              className="text-sm leading-relaxed border-l-2 border-orange-500 pl-4"
              style={{ color: isDark ? "#b0bcc8" : "#475569" }}
            >
              Convert any text to proper title case instantly with our free online tool. Whether
              you're writing <strong style={{ color: textPrimary }}>blog post titles</strong>,
              book chapters, article headings, or email subjects, this{" "}
              <strong style={{ color: textPrimary }}>title case converter</strong> correctly
              capitalizes major words and leaves minor words lowercase — no installation required.
            </p>
          </section>
          ...
          <section className="pt-12" aria-labelledby="what-is-heading">
            ...
            <p className="text-sm leading-relaxed" style={{ color: textMuted }}>
              Title case is a capitalization style where the{" "}
              <strong style={{ color: textPrimary }}>first letter of major words is capitalized</strong>{" "}
              while minor words like articles, conjunctions, and short prepositions remain lowercase
              — unless they appear as the first word. For example:{" "}
              <span
              ...
              — "The", "Lord", "Rings" are capitalized but "of" and "the" (mid-sentence) are not.
            </p>
          </section>
          ...
          <section className="pt-12" aria-labelledby="how-to-heading">
            ...
            <ol className="flex flex-col gap-3 list-none p-0">
              {[
                ...
                { n: "3", title: "Copy or download", desc: "the result — ready to use in your document, email, or post." },
              ].map(({ n, title, desc }) => (
                <li
                  key={n}
          ...
          {/* Title Case Rules */}
          <section className="pt-12" aria-labelledby="rules-heading">
            <h2
              id="rules-heading"
              className="text-lg font-semibold mb-4 pb-3"
              style={{ color: textPrimary, borderBottom: borderStyle }}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                {
                  icon: "✅",
                  label: "Always capitalize",
                  desc: "Nouns, verbs, adjectives, adverbs, and the first word of the title.",
                  color: isDark ? "#0f1a12" : "#f0fdf4",
                  border: isDark ? "#142014" : "#bbf7d0",
                  text: isDark ? "#86efac" : "#15803d",
                },
                {
                  icon: "🔡",
                  label: "Keep lowercase",
                  desc: 'Articles (a, an, the), short prepositions (in, on, at, by, of, to), and conjunctions (and, but, or).',
                  color: isDark ? "#1c1810" : "#fff7ed",
                  border: isDark ? "#292010" : "#fed7aa",
                  text: isDark ? "#fdba74" : "#c2410c",
                },
                {
                  icon: "🔠",
                  label: "First word always caps",
                  desc: "Even if the first word is a minor word, it is always capitalized.",
                ...
                {
                  icon: "📝",
                  label: "Preserves line breaks",
                  desc: "Each line is treated independently, so multi-line titles convert correctly.",
                  color: isDark ? "#111827" : "#f8fafc",
                  border: isDark ? "#1f2937" : "#e2e8f0",
                  text: textMuted,
                },
                ...
                >
                  ...
                  <strong style={{ color: textPrimary }}>{label}</strong>
                  <p className="text-xs leading-snug mt-1 m-0" style={{ color: text }}>{desc}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="pt-12" aria-labelledby="examples-heading">
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                <div
                  key={inp}
                  className="rounded-lg p-4 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-sm"
                ...
                >
                  ...
                  <span className="text-lg hidden sm:block" style={{ color: textDim }}>→</span>
                  <span className="text-sm sm:hidden" style={{ color: textDim }}>↓</span>
                  <div className="flex-1">
          ...
          <section className="pt-12" aria-labelledby="benefits-heading">
            <h2
              ...
              style={{ color: textPrimary, borderBottom: borderStyle }}
            >
              Why Use This Title Case Converter?
            </h2>
            <ul className="flex flex-col gap-2 list-none p-0">
              {[
                "Correctly handles minor words — not just a simple capitalize-all",
          ...
          <section className="pt-12" aria-labelledby="use-cases-heading">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {[
                { icon: "✍️", title: "Writers & Bloggers", desc: "Format blog post and article titles correctly every time." },
                { icon: "🎓", title: "Students", desc: "Properly format essay headings and paper titles." },
                { icon: "📧", title: "Email Marketers", desc: "Write professional subject lines in seconds." },
                { icon: "🎬", title: "Content Creators", desc: "Nail YouTube video titles and thumbnail text." },
                { icon: "🔍", title: "SEO Experts", desc: "Format page titles and meta headings consistently." },
                { icon: "💼", title: "Professionals", desc: "Polish reports, presentations, and document headings." },
              ].map(({ icon, title, desc }) => (
                <div
                  key={title}
          ...
          <section className="pt-12" aria-labelledby="also-search-heading">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                "headline capitalization checker",
                "AP style title case",
                "APA title case converter",
                "Chicago style capitalization",
                "convert to title case free",
              ].map((tag) => (
                <span
                  key={tag}
          ...
          <section className="pt-12" aria-labelledby="related-heading">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                { href: "/uppercase-to-lowercase", icon: "lc", label: "bg-green-600", title: "Uppercase to Lowercase", desc: "Convert all capital letters to small letters." },
                { href: "/sentence-case-converter", icon: "Ss", label: "bg-purple-600", title: "Sentence Case Converter", desc: "Capitalize only the first letter of each sentence." },
                { href: "/lowercase-to-uppercase", icon: "UC", label: "bg-blue-600", title: "Lowercase to Uppercase", desc: "Transform small letters into all caps instantly." },
                { href: "/word-counter", icon: "##", label: "bg-teal-600", title: "Word Counter Tool", desc: "Count words, characters, sentences, and more." },
              ].map(({ href, icon, label, title, desc }) => (
                <Link
                  key={href}
                  href={href}
                ...
                >
                  <span
                    className={`w-10 h-10 min-w-10 rounded-lg flex items-center justify-center text-xs font-bold font-mono text-white ${label}`}
                  >
                    {icon}
                  </span>
                  <div>
              ...
              {[
                {
                  ...
                  a: 'Title case capitalizes the first letter of each major word while keeping minor words like "and", "the", and "of" in lowercase — unless they appear as the first word.',
                },
                {
                  q: "Which words are not capitalized in title case?",
                  a: "Articles (a, an, the), coordinating conjunctions (and, but, or, nor, for, so, yet), and short prepositions (in, on, at, by, of, to, up, as) are not capitalized unless they start the title.",
                },
                {
                  q: "Is this title case converter free?",
                ...
                {
                  q: "Does this follow AP, APA, or Chicago style?",
                  a: "This tool follows general title case conventions. Minor differences exist between style guides (AP, APA, Chicago, MLA), but the core rules — capitalize major words, lowercase minor words — are consistent across all of them.",
                },
              ].map(({ q, a }, i) => (
                <details
                  key={i}
          ...
          >
            <p className="text-sm mb-5" style={{ color: textMuted }}>
              Try our free{" "}
              <strong style={{ color: textPrimary }}>title case converter</strong> now — paste your
              text and it formats instantly. No sign-up, no download.
            </p>
            <button
