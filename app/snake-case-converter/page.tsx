...
export const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "What is snake case format?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Snake case is a naming convention where words are lowercase and separated by underscores, like 'hello_world'.",
      },
    },
    {
      "@type": "Question",
      name: "Where is snake case used?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Snake case is commonly used in programming languages like Python, databases, and file naming.",
      },
    },
    {
      "@type": "Question",
      name: "Does this tool support bulk text conversion?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, you can convert large amounts of text into snake case instantly.",
      },
    },
    {
      "@type": "Question",
      name: "Is snake case better than camel case?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "It depends on the language or style guide. Snake case is preferred in Python, while camel case is common in JavaScript.",
      },
    },
  ],
};
...
export const webAppSchema = {
  ...
  url: "https://convertcase.in/snake-case-converter",
  description: "Convert text to snake_case format instantly. Ideal for developers, databases, and coding standards.",
...
export default function SnakeCaseConverter() {
  ...
  const handleConvert = useCallback(() => {
    setOutput(input.split('\n').map((line) => toSnakeCase(line)).join('\n'));
  }, [input]);
  ...
  const relatedTools = [
    ...
    { href: '/slug-case-converter', icon: 'sc', title: 'Slug Case Converter', desc: 'Convert text to slug-case for URLs.' },
    ...
    >
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-semibold mb-2">Snake Case Converter</h1>
          <p className="text-sm" style={{ color: textMuted }}>
            Convert any text into <code>snake_case</code> format. Replaces spaces and hyphens with underscores, handles camelCase splitting, and lowercases everything — the standard for Python variables, database columns, and JSON keys.
          </p>
        </div>
        ...
        <div className="rounded-xl border" style={{ background: surface, borderColor, boxShadow: isDark ? 'none' : '0 1px 8px rgba(0,0,0,0.06)' }}>
          <label className="block px-4 pt-3 text-xs font-semibold" style={{ color: textMuted }}>OUTPUT — snake_case</label>
          <textarea
            className="w-full bg-transparent p-4 pt-2 text-sm rounded-xl resize-none focus:outline-none"
            rows={6}
            readOnly
            placeholder="Your snake_case result will appear here"
            value={output}
        ...
        <div className="rounded-xl border mt-4 p-4" style={{ background: isDark ? '#0d1117' : '#f1f5f9', borderColor }}>
          ...
          <div className="flex flex-col gap-1 text-sm" style={{ fontFamily: '"Courier New", monospace' }}>
            <p style={{ color: textMuted }}>Input: &nbsp;&nbsp;<span style={{ color: textPrimary }}>"Hello World" / "helloWorld" / "Hello-World"</span></p>
            <p style={{ color: textMuted }}>Output: <span style={{ color: '#6366f1' }}>hello_world</span></p>
          </div>
        </div>
      ...
      />
        ...
        <section className="pb-16" aria-labelledby="faq-heading">
          <h2 id="faq-heading" className="text-lg font-semibold mb-4 pb-3" style={{ color: textPrimary, borderBottom: borderStyle }}>About Snake Case</h2>
          <div style={{ color: textMuted, fontSize: '0.875rem', lineHeight: '1.75' }}>
            <p style={{ marginBottom: '1rem' }}>
              <strong style={{ color: textPrimary }}>Snake case</strong> is a naming convention where words are separated by underscores (<code>_</code>) and all letters are lowercase. It's the dominant style in Python, Ruby, and database schemas.
            </p>
            <h3 style={{ color: textPrimary, fontWeight: 600, marginBottom: '0.5rem' }}>When should I use snake_case?</h3>
            <ul style={{ paddingLeft: '1.25rem', marginBottom: '1rem', listStyleType: 'disc' }}>
              <li>Python variables and functions: <code>user_name</code>, <code>get_user_data()</code></li>
              <li>Database column names: <code>created_at</code>, <code>first_name</code></li>
              <li>Ruby variables and methods</li>
              <li>JSON API keys (common convention)</li>
            </ul>
            <h3 style={{ color: textPrimary, fontWeight: 600, marginBottom: '0.5rem' }}>Does it handle camelCase input?</h3>
            <p>Yes — <code>helloWorld</code> becomes <code>hello_world</code>, <code>ABCParser</code> becomes <code>abc_parser</code>.</p>
          </div>
        </section>
